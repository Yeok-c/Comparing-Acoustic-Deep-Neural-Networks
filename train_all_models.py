...
for MODEL_NAME in Network_architectures:
        # print(MODEL_NAME)
        command="""python train.py -d C:/Users/User/Documents/cer_dataset_16k_resampled_split/ \
        -u {} -a {} -e 20 -s {} -p 1 -t {} -r 1""".format(
                        NUM_DENSE_UNITS, MODEL_NAME, SEED, DATETIME_NOW)

        #     command="python train_hp_tuners.py -d C:\\Users\\User\\Documents\\cer_dataset_16k_resampled_split\\ -u {} -a {} -e 20 -s {} -p 1 -t {} -r 1".format(
        #            NUM_DENSE_UNITS, MODEL_NAME, SEED, DATETIME_NOW)
        print(command)
        os.system(command)