...
def myfunc(argv):
    ...
    arg_output = ""
    arg_user = ""
    arg_help = "{0} -d <dataset_dir*> -a <architecture*> -e <epochs(default=40)> -s <seed(default=42)> -p <patch_hop_distance(default=0.25)>".format(argv[0])
    
    try:
        opts, args = getopt.getopt(argv[1:], "hd:a:e:s:p:t:r:", ["help", "dataset_dir=", "architecture=", 
    ...
    return arg_dataset_dir, arg_hop_distance, arg_epochs, arg_architecture, arg_seed, arg_timenow, arg_ratio
    
if __name__ == "__main__":
    DATASET_DIR, PATCH_HOP_DISTANCE, EPOCHS, MODEL_NAME, SEED, DATETIME_NOW, FILE_RATIO = myfunc(sys.argv)
